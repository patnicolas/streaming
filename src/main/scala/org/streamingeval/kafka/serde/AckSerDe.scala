...
import org.streamingeval.kafka.serde.AckSerDe.AckMessage
...
/**
  ...
  * @version 0.6
  */
private[streamingeval] final class AckDeserializer extends Deserializer[AckMessage] {
...
private[streamingeval] object AckSerDe extends SerDe {
