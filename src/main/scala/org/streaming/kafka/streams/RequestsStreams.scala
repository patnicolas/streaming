 ...
 */
package org.streaming.kafka.streams
...
import org.streaming.kafka.serde.{RequestDeserializer, RequestSerDe, RequestSerializer, ResponseDeserializer, ResponseSerializer}
import org.streaming.kafka.stringSerde
import org.streaming.{RequestMessage, RequestPayload, ResponseMessage, ResponsePayload}
 ...
 * @version 0.0.1
 */
private[streaming] final class RequestsStreams(proc: RequestPayload => ResponsePayload)
 ...
 */
private[streaming] object RequestsStreams {
