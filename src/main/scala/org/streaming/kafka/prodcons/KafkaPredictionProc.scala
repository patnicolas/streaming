...
import org.streaming.kafka.prodcons.KafkaPredictionProc.{RequestKeyMap, logger}
import org.streaming.kafka.serde.{RequestSerDe, ResponseSerDe}
...
/**
  ...
  * @version 0.0.1
  */
private[streaming] final class KafkaPredictionProc private(
...
/**
  ...
  */
private[streaming] object KafkaPredictionProc {
