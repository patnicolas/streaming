 ...
 * @version 0.0.2
 */
private[streaming] case class SparkConfiguration(sparkParameters: Seq[ParameterDefinition])
...
private[streaming] object SparkConfiguration {
  import org.streaming.util.LocalFileUtil._
