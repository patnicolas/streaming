...
import org.pipeline.streams.kafka.{KafkaAdminClient, KafkaTopicException}
import org.pipeline.streams.kafka.KafkaAdminClient.{consumerProperties, isAlive}
 ...
 * @version 0.0.1
 */
private[streams] final class TopicsManager private(properties: Properties) {
 ...
 */
private[streams] object TopicsManager {
