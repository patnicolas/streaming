...
import org.pipeline.streams.kafka.prodcons.KafkaPredictionProc.{RequestKeyMap, logger}
import org.pipeline.streams.kafka.serde.{RequestSerDe, ResponseSerDe}
...
/**
  ...
  * @version 0.0.1
  */
private[streams] final class KafkaPredictionProc private(
...
/**
  ...
  */
private[streams] object KafkaPredictionProc {
