...
import org.pipeline.streams.RequestMessage
...
/**
  ...
  * @version 0.0.1
  */
private[streams] final class RequestDeserializer extends Deserializer[RequestMessage] {
...
/**
  ...
  * @version 0.0.1
  */
private[streams] object RequestSerDe extends SerDe {
