...
import org.pipeline.streams.kafka.serde.AckSerDe.AckMessage
...
/**
  ...
  * @version 0.6
  */
private[streams] final class AckDeserializer extends Deserializer[AckMessage] {
...
private[streams] object AckSerDe extends SerDe {
