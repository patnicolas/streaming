/**
  ...
  */
package org.pipeline.streams.kafka.serde


import org.apache.kafka.common.serialization.{Deserializer, Serializer}
import org.pipeline.streams.ResponseMessage

import java.util
import org.pipeline.streams.kafka.serde.SerDe.serDePrefix
...
/**
  ...
  * @version 0.5
  */
private[streams] final class ResponseSerializer extends Serializer[ResponseMessage] {
...
/**
  ...
  * @version 0.0.1
  */
private[streams] final class ResponseDeserializer extends Deserializer[ResponseMessage] {
...
/**
  ...
  * @version 0.0.1
  */
private[streams] object ResponseSerDe extends SerDe {
